...
\begin{document}
    ...
    \section*{Experiencia Laboral}
        \experience{2019 -- Presente}{Apoyo Tecnol\'ogico Vicerrector\'ia Acad\'emica - Universidad de Atacama}{
            Actualmente trabajando en el desarrollo de una aplicaci\'on para llevar el seguimiento y cumplimiento del modelo educativo de la universidad, desarrollada en lenguaje \emph{Python} para el \emph{backend} y base de datos \emph{MYSQL}.
            
            Por otra parte, apoyando a la unidad de An\'alisis institucional mediante la implementaci\'on de una plataforma para integrar informaci\'on proveniente de fuentes tanto internas como externas y la generaci\'on de indicadores a partir de las mismas.
        }
        \experience{2013 -- 2019}{Ingeniero de Soporte Tecnol\'ogico - Universidad de Atacama}
        {
