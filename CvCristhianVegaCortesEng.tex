...
\begin{document}
    \begin{header}
        ...
        \major{IT Engineer}\\
        \contact{\faLinkedin : \href{http://www.linkedin.com/in/cristhianvega}{cristhianvega}}{\Mobilefone : +569 5 965 7229}{\Letter : cristhianv.info@gmail.com - \faGithub : \href{http://github.com/kernuac}{kernuac}}
    \end{header} 
     
    \section*{Abstract}
        \resume{
        I'm a self-taught person who is constantly looking for learning about new technologies
        and how I can use them for improving proccess or systems and simplify tasks. 
        Also I'm an independent person who can solve problems without a constant supervision.
        }  
        
    \section*{Work Experience}
        \experience{2019 -- Presente}{Technological Support Engineer for Academic Vice Rectory - Universidad de Atacama - Chile}{
            I'm currently developing an application for tracking how the educational model is fullfied. This software is written in Python ( backend ) and consume data from a MySQL server.
            
            On the other hand, I'm working together with the Institutional Analisys Unit on the data integration from different sources (internal and external) and generating indicators from them.  
